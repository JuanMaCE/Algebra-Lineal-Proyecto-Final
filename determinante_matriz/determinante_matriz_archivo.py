...
def labels_parte1(frame):
    lb_titulo = customtkinter.CTkLabel(master=frame, text='Deteminante de una matriz',
                                        font=("Times New Roman", 50, "bold"))
    lb_titulo.pack(pady=400, padx=400, )
    lb_titulo.place(x=10, y=0)

    lb_filas = customtkinter.CTkLabel(master=frame, text='Dimensión de la matriz')
